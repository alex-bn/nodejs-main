...
// const User = require('./userModel'); // to be used with embedding
...
const tourSchema = new mongoose.Schema(
  {
    ...
    ratingsAverage: {
      ...
      set: (val) => Math.round(val * 10) / 10, // 4.666 => 5, 4.7, 46.666 => 47 / 10 = 4.7
    },
    ratingsQuantity: {
      type: Number,
      default: 0,
    ...
    startLocation: {
      ...
      type: {
        type: String,
        default: 'Point',
        enum: ['Point'], // setting the values range, in this case can have only one value
      },
      coordinates: [Number],
      address: String,
      description: String,
